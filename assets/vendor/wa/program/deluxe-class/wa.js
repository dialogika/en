$(document).on('click','.send_form', function(){
    ...
    var walink = 'https://web.whatsapp.com/send',
        phone = '6282137760669',
        walink2 = 'Halo Ka, Saya melihat *Info Kelas Offline Dialogika* dan saya tertarik untuk mendaftar .' + '%0A %0A' 
...
$(document).on('click','.send_contact', function(){
    ...
    var walink = 'https://web.whatsapp.com/send',
        phone = '6282137760669',
        walink2 = '*Deluxe di Jogja* : Saya Tertarik untuk mendaftar dan ke Jogja' + '%0A %0A' 
